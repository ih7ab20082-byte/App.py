...
with col_output:
    ...
    if selected_abx == "Tazocin (Piperacillin/Tazobactam)":
        ...
        else:              st.error("🚨 **Severe Renal Dosing:** Give **2.25 g IV every 6 hours** (or 3.375 g IV every 8 hours).")
        ...
        st.success("🟢 **No Adjustment Required for Renal Impairment Alone:** Dual hepatic/renal elimination. Give **1 g to 2 g IV every 24 hours** safely. *Monitor only if concomitant liver failure is documented.*")
