...
with col_input:
    ...
    fluid_choice = st.selectbox(
        "Select Infusate Fluid Fluid type to utilize:",
...
# ==============================================================================
# RIGHT COLUMN: Adrogue-Madias Formula & Speed Limit Safeguards
# ==============================================================================
with col_protocol = col_math:
    ...
    # Formula: Delta Na per 1 Liter of Infusate = (Infusate Na - Serum Na) / (TBW + 1)
    ...
    # ------------------------------------------------------------------
        ...
        if "D5W" in fluid_choice:
            d5w_rate = (water_deficit * 1000) / 48 # Usually replaced over 48h
