...
<div class='branding-bar'>
    <div class='branding-text'>
        ...
        <strong>Clinical Core:</strong> AASLD & EASL Guidelines, MELD-Na Calculator, Post-Paracentesis Induced Circulatory Dysfunction (PICD) Prevention Protocols
    </div>
</div>
""", unsafe_allow_html=True)
...
with col_input:
    ...
    # ==========================================================================
    # MELD-Na 2016 Equation Safeguards
    ...
    # FIXED: Replaced brackets [] with regular parentheses () to fix the TypeError
    if meld_pure > 11:
...
with col_dashboard:
    ...
    with tab_strat:
        ...
        if meld_na >= 15:
            st.error(f"⚠️ **High Mortality Risk Alert (MELD-Na ≥ 15):** The patient should be evaluated for liver transplantation referral.")
        else:
        ...
        if is_paracentesis:
            ...
            if ascitic_volume > 5.0:
                ...
                * **Timing:** Infuse concurrently or immediately post-tap to preserve intra-vascular volume and prevent acute HRS-AKI.
                ...
                st.warning("⚪ **Volume ≤ 5 Liters:** Albumin substitution is optional but generally recommended if baseline kidney function is compromised.")
        else:
...
st.info("""
**Question 2:** A 61-year-old female with Child-Pugh Class C cirrhosis is brought due to progressive confusion over the past 24 hours. On physical examination, she is somnolent, grossly disoriented, and exhibits asterixis.
...
* **Correct Answer for Club Discussion:** **B**. *Rationale:* The patient presents with overt Hepatic Encephalopathy (West Haven Grade 3). Aggressive lactulose titration is the cornerstone of management, along with ruling out precipitating factors like SBP.
""")
