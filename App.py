...
with col_eval:
    ...
    if "Ischemic" in imaging_type or "Diffusion" in imaging_type:
        with st.expander("📝 Comprehensive NIHSS Calculator (AHA/ASA Standard)", expanded=True):
            ...
            n13 = st.radio("11. Extinction and Inattention (Visual, tactile, or spatial neglect):", (0, 1, 2), 
            ...
            total_nihss = n1a + n1b + n1c + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n13
    ...
    if "Hemorrhagic" in imaging_type:
        ...
        if not nihss_calculated:
            ...
            if onset_time <= 4.5 and (sbp > 185 or dbp > 110):
                st.error("⚠️ BP CONTRAINDICATION: Blood pressure is above tPA thresholds (>185/110 mmHg). Title aggressive IV Labetalol 10-20mg or Nicardipine titration. Lower SBP < 185 to unlock Thrombolysis eligibility.")
            ...
            if "Thrombolysis" in treatment_path:
                ...
                if evt_eligible and tpa_eligible:
                    st.warning("🧠 **AHA/ASA BRIDGING MANDATE ACTIVE:** Patient satisfies criteria for both IV Thrombolysis and EVT. **Start tPA infusion immediately and transfer to Angio-Suite simultaneously.** DO NOT wait to assess clinical efficacy of tPA.")
            ...
            with st.expander("🔬 View Complete Diagnostic & Secondary Prevention Workup", expanded=True):
                ...
                * [ ] **12-Lead ECG:** Immediate screening for Occult Atrial Fibrillation or acute ischemic changes.
